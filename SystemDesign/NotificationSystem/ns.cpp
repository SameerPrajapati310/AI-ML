...
private:
    ...
    static NotificationService* instance; // what is this doing????
...
public:
    NotificationEngine() {
        this->notificationObservable = NotificationService::getInstance()->getObservable();
        notificationObservable->addObserver(this); // why we are doing addObserver(this) what this is pointing to ?????
    }

    NotificationEngine(NotificationObservable* observable) { // why this second constructor
        this->notificationObservable = observable;
    }
...
int main() {
    ...
    NotificationService* notificationService = NotificationService::getInstance(); // why are create obejct of this second time
